                    ...
                    if visualize_correct:
                        ...
                        batch_visualize_predictions(
                            ...
                            segmented_image_dir=str(
                                os.path.join(os.getcwd(), "Dataset/segmented_image")
                            ),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["E1", "E2"],
        help="List of environment strategies (E1, E2, E3_MEA, E4_CYA, etc.)",
    )
    parser.add_argument(
        "--agg_strategies",
        nargs="+",
        default=["avg", "uni"],
        help="List of aggregation strategies (avg, uni)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="Max number of visualizations per run",
    )
    parser.add_argument(
        "--no-viz-correct",
        action="store_false",
        dest="visualize_correct",
        help="Disable visualization of correct predictions",
    )
    parser.add_argument(
        "--no-viz-incorrect",
        action="store_false",
        dest="visualize_incorrect",
        help="Disable visualization of incorrect predictions",
    )
