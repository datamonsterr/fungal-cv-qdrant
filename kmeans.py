...
def segment_kmeans(img_path: str) -> List[Dict[str, int]]:
    ...
    if avg_vote == 0:
        ...
        raise RuntimeError("Unexpected vote average in KMeans segmentation")
...
if __name__ == "__main__":
    img_paths = os.listdir(os.path.join("file_server", "images"))
    for img_path in img_paths:
        original_img_path = os.path.join("file_server", "images", img_path)
        bboxes = segment_kmeans(original_img_path)
